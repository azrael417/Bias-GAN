...
#parameters
gpu_id=1
run_tag="adversarial3d_new_run2"
data_dir_prefix="/data/gpsro_data3_interp"
output_dir="${data_dir_prefix}/runs/${run_tag}"
checkpoint_file="${data_dir_prefix}/runs/adversarial3d_new_run1/gan_step_8000.cpt"
...
mpirun -np ${totalranks} ${mpioptions} python train_gan3d.py \
       ...
       --weight_decay 0.05 \
       --start_lr_generator 0.0001 \
       --start_lr_discriminator 0.0001 \
       --generator_warmup_steps 8000 \
       --relative_update_schedule type="adaptive",acc_min=0.3,acc_max=0.7 \
