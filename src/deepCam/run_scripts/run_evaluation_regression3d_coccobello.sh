...
data_dir_prefix="/data/gpsro_data_hires/test_2020"
...
output_dir="${data_dir_prefix}/runs/${run_tag}/test_2020_step_22000"
checkpoint_file="/data/gpsro_data_hires/runs/${run_tag}/regressor_step_22000.cpt"
